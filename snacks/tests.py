...
class SnacksTest(TestCase): 
    def setUp(self):
        ...
        Snack.objects.create(name="hamzeh", purchaser=purchaser)
    ...
    def test_list_page_context(self):
        ...
        self.assertEqual(snacks[0].name, "hamzeh")
        self.assertEqual(snacks[0].description, 'bla bla ...')
    ...
    def test_detail_page_context(self):
        ...
        self.assertEqual(snack.name, "hamzeh")
        self.assertEqual(snack.description, 'bla bla ...')
